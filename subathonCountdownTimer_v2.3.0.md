...
+ Added action 'Subathon 0a. Set YouTube Membership Tiers' for configuring your YouTube membership tier level names
...
- Fixed bug to have messages sendAsBot by default
